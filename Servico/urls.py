...
from .views import administrador_usuario, administrador_servico, historico_usuario, \
    ...
    suporte_admin, suporte_usuario, status_comentar_status, buscar_por_status    
...
urlpatterns = [
    ...
    path('status_comentar_status/<int:id>/', status_comentar_status, name='status_comentar_status'),
